...
export default function Home() {
  ...
  //api call // usenav // usesttate //use effect
  ...
  const apidatafetch = async()=>{
    try {
          const response =     await axios.get('https://68e5edbf21dd31f22cc36bec.mockapi.io/furnitureapp/furnitureapi')
    setapidata(response.data)
    } catch (error) {
      console.log("data is not fetched in homepage");
    }
  }
