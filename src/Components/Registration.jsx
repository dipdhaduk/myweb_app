...
export default function Registration() {
 ...
 <form>
  <div className="form-group">
    ...
    <input type="text" className="form-control" value={(e)=>(setusername(e.target.value))} aria-describedby="emailHelp" placeholder="Enter email" />
    <small id="userHelp" className="form-text text-muted">Your Username</small>
  </div>
  <div className="form-group">
    <label htmlFor="exampleInputEmail1">Email address</label>
    <input type="email" className="form-control" value={(e)=>(setemail(e.target.value))} aria-describedby="emailHelp" placeholder="Enter email" />
    <small id="emailHelp" className="form-text text-muted">We'll never share your email with anyone else.</small>
  </div>
  <div className="form-group">
    <label htmlFor="exampleInputPassword1">Password</label>
    <input type="password" className="form-control" value={(e)=>(setpass(e.target.value))} placeholder="Password" />
  </div>
